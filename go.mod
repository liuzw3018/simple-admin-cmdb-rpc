module github.com/liuzw3018/simple-admin-cmdb-rpc

go 1.21.1

require (
	entgo.io/ent v0.12.4
	github.com/suyuan32/simple-admin-common v1.1.5
...
replace github.com/zeromicro/go-zero v1.5.6 => github.com/suyuan32/simple-admin-tools v1.5.17
